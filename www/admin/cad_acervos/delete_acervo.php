...
if ($row) {
    ...
    if ($deleteStmt->execute()) {
        // Agora, resetamos a sequência de IDs para a tabela "cad_acervo"
        $resetSeqQuery = "DELETE FROM sqlite_sequence WHERE name='cad_acervo'";
        $mysqli->exec($resetSeqQuery); // Executa a limpeza da sequência de IDs
