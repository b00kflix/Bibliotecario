    ...
    $(document).ready(function() {
        ...
        $('#cadastroForm').on('submit', function(e) {
            ...
            if (!imgSrc.startsWith('data:image/')) {
                // Usa um proxy PHP para carregar a imagem
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        base64Image = response.image_src; // Assume que o proxy retorna a imagem em Base64
        ...
        function enviarFormulario(base64Image) {
            ...
            $.ajax({
                url: 'cad_acervos/salva_acervo.php', // URL do arquivo PHP que processará os dados
                method: 'POST',
                data: formData,
