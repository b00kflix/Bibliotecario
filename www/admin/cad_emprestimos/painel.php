...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <button type="button" class="btn btn-success novo_cadastro">Registrar Novo Empréstimo</button>  
                 <button type="button" class="btn btn-primary ver_tabela">Visualizar Tabela Geral</button>
...
<script>
    $(function(){
        ...
        $(".novo_cadastro").click(function(){
            $("#tabela").load("cad_emprestimos/cadastro/cad_emprestimo.php")
        })
