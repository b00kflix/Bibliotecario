...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2><i class="fa fa-bar-chart"></i> Relatórios de Gestão</h2>
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group">
                            <input type="text" name="ano" id="ano" class="form-control" placeholder="Digite o ano"> 
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="form-group">
                    ...
                    <div class="col-md-2">
                        <button class="btn btn-primary abrir_rel">Abrir Relatório</button>
                    </div>
                </div>
                <div id="tabela"></div>
            </div>
        ...
        $('.abrir_rel').click(function () {
            ...
            if (!ano) {
                Swal.fire({
                    ...
                    text: 'Selecione um ano para emitir o relatório',
                });
            } else if (ano && !mes) {
                $("#tabela").load("cad_relatorio/rel_ano.php?ano=" + ano);
            } else {
                $("#tabela").load("cad_relatorio/rel_mes.php?ano=" + ano + "&mes=" + mes);
            }
        });
    });
</script>
